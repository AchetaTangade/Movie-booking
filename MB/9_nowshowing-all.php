...
<?php 
    if(isset($_SESSION["username"]) && isset($_SESSION["cusid"] ) ):
    ?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <!-- <link rel="stylesheet" type="text/css" href="css/11_cust.css"> -->
...
<body style="background-color:black;">
    ...
    <div class="outer-right">
        <div class="list" style="width:100%"; >
            <ul style="float:left; background-color:black; color:white; text-align:center;">
                ...
                <li>
                    <a href="9_nowshowing-all.php" class="active" style="background-color:darkslategray; color:#ffb500; width:4cm;border-top-left-radius: 10px;
    border-bottom-left-radius: 10px;">All</a>
                ...
                <li><a href="14_nowshowing-malayalam.php" style="background-color:darkslategray; color:antiquewhite;width:4cm;">Malayalam</a></li>
    ...
    border-top-right-radius: 10px;">Telugu</a></li>
        ...
        <div class="moviedisplay" style="border:3px solid black;position:relative;">   
            ...
            <b class="1" style="font-size:22px;" >
                    <?php        echo $row['movie_name']."(".$row['language'].")" ?>
            </b>        
                <p class="display">
                ...
                <form action="17_booking.php" method="POST">
                    ...
                    <center>
                        <input type="submit"  class="book-button" value="Book" name="book" >
            ...
            <div class="moviepic">  
                <center>
                    <img style="border:2px solid white;" src="<?php echo $image ?> " />   
                </center>
            </div>
